...
//			ItemsQueryVo itemsQueryVo)throws Exception{
	public String editItemSubmit(Integer id,ItemsCustom itemsCustom,MultipartFile pictureFile)throws Exception{
		
		if(pictureFile != null && !"".equals(pictureFile.getOriginalFilename())){
			String filePath = "E:\\temp\\upload";
			String oldFilePath = itemsCustom.getPic();
...
//		return "forward:queryItems.action";
	...
	public @ResponseBody Items getJson(Integer id) throws Exception{
